...
import {formatApparentTemperature, formatWindSpeed} from "./Utils";
...
function WeatherDetails({weatherData}) {
    ...
    const {apparent_temperature_max, uv_index, humidity, wind_speed, precipitation_probability_mean} = weatherData;
    const apparent_temp_max = formatApparentTemperature(apparent_temperature_max)
    const wind = formatWindSpeed(wind_speed)
